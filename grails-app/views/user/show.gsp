    ...
    <div id="show-user" class="content scaffold-show" role="main">
        ...
        <ol class="property-list user">
            ...
            <g:if test="${userInstance?.image}">
                <li class="fieldcontain">
                    <span id="image-label" class="property-label"><g:message code="user.image.label"
                                                                             default="Image"/></span>

                </li>
            </g:if>

            <g:if test="${userInstance?.providerCode}">
                <li class="fieldcontain">
                    <span id="providerCode-label" class="property-label"><g:message code="user.providerCode.label"
                                                                                    default="Provider Code"/></span>

                    <span class="property-value" aria-labelledby="providerCode-label"><g:fieldValue
                            bean="${userInstance}"
                            field="providerCode"/></span>
        ...
        <g:form url="[resource: userInstance, action: 'delete']" method="DELETE">
            <fieldset class="buttons">
                <g:link class="edit" action="edit" resource="${userInstance}"><g:message
